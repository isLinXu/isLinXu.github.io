...
Xu Lin is an AI engineer and researcher whose public work is mainly connected to multimodal models, computer vision, evaluation, and applied engineering.
...
This site is not meant to claim every possible capability. It mainly collects the parts that are easier to verify from public materials:
...
Recent repositories and public profile material point to several recurring directions:
...
This page is meant to be a concise and verifiable summary. More detailed project and achievement information is split across the `Projects`, `Highlights`, and `Publications` pages.
